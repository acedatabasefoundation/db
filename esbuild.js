...
esbuild.build({ // // https://esbuild.github.io/api/
  ...
  entryPoints: [ // This is an array of files that each serve as an input to the bundling algorithm.
    ...
    './tsc/src/schema/deleteNodePropsByName.js',
    './tsc/src/schema/deleteNodesByName.js',
    './tsc/src/schema/doneUpdate.js',
    './tsc/src/schema/revertWriteSchema.js',
    './tsc/src/schema/setSchema.js',
    './tsc/src/schema/updateNodeName.js',
    './tsc/src/schema/updateNodePropName.js',
    './tsc/src/schema/updateRelationshipName.js',
    './tsc/src/schema/updateRelationshipPropName.js',
